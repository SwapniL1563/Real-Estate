...
const Contact = () => {
  return (
    ...
    <div className="w-full bg-secondary flex">
        <div className='w-[85%] flex justify-start items-center py-20 px-20 '> 
            <h1 className='text-4xl text-white' >Let's find you the dream <br /> home you always deserved.</h1>
        </div>
        <div className='w-[15%] flex justify-end items-center px-20 bg-primary'>
